...
const Home = () => {
  const commitments = [
    ...
    },
    {
      ...
      title: "Support",
      description:
        "A dedicated project team will guide you through your project. When you have questions or concerns, we're right by your side.",
    },
  ];
  ...
  const process = [
    ...
    },
    {
      ...
      description: "On-time completion with professional support",
    },
  ];
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="max-w-3xl">
              <h1 className="text-5xl md:text-7xl font-bold text-primary-foreground mb-6 leading-tight">
                ...
                <span className="text-accent">thoughtful design</span> and
                flawless execution.
              </h1>
              <p className="text-xl md:text-2xl text-primary-foreground/90 mb-10 leading-relaxed">
                ...
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="text-lg border-2 border-primary-foreground/30 text-primary-foreground bg-transparent hover:bg-primary-foreground/10 h-14 rounded-xl backdrop-blur-sm"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                Based in Alameda, New Mexico, RedRock Fabrications brings years
                of experience in steel fabrication to every project. Our team
                prides itself on outstanding customer service and on-time
                delivery of superior products.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                We take pride in transforming ideas into reality through a
                meticulous approach to design, fabrication, skilled project
                execution, and trust to deliver excellence.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6">
              {stats.map((stat, index) => {
                ...
                return (
                  <Card
                    key={index}
                    className="border-2 border-border hover:border-accent/50 transition-all hover:shadow-xl group"
                  >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              With every job we take on, RedRock Fabrications promises to
              deliver:
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              The work we do at RedRock Fabrications is cutting edge, but every
              project comes down to how our team handles your needs. Our turnkey
              steel fabrication services range from the design phase through to
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {services.map((service, index) => (
              <Card
                key={index}
                className="border-2 border-border hover:border-accent/50 transition-all hover:shadow-xl group cursor-pointer overflow-hidden"
              >
      ...
      <section className="py-24 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              At RedRock, we don't just build — we craft. Every space we deliver
              is a reflection of thoughtful design, expert planning, and precise
              execution.
            </p>
          </div>
      ...
      <section className="py-24 bg-primary text-primary-foreground relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,rgba(255, 255, 255, 1))]" />
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-xl md:text-5xl mb-10 text-primary-foreground/90 leading-relaxed max-w-3xl mx-auto">
            Ready to Start Your Project?
          </h2>
          <p className="text-xl md:text-2xl mb-10 text-primary-foreground/90 leading-relaxed max-w-3xl mx-auto">
            Let us put our experience to use helping you execute your next
            fabrication project with a level of skill and support you won't find
            anywhere else.
          </p>
          <Button
            asChild
            size="lg"
            className="bg-accent hover:bg-accent/90 text-lg px-8 h-14 rounded-xl"
          >
            <Link to="/contact">
